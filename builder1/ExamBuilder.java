...
public class ExamBuilder {
	...
	public ExamBuilder addTrueFalseQuestion(String content, double weight, String answer) {
		questionList.add(new TrueFalseQuestion(content, weight, answer));
		return this;
	}
	
	public ExamBuilder addMultipleChoiceQuestion(String content, double weight, ArrayList<String> option, String answer) {
